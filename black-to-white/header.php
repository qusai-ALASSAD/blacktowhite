...
<header class="site-header fixed w-full z-50 bg-black bg-opacity-90">
        ...
        <div class="flex justify-between items-center h-20">
            ...
            <nav class="hidden md:flex space-x-8">
                ...
                <a href="#contact" class="bg-white text-black px-4 py-2 rounded-md hover:bg-gray-100 transition-colors">
                    <?php _e('Kostenlos anfragen', 'black-to-white'); ?>
                </a>
            </nav>

            <button class="md:hidden text-white mobile-menu-btn" aria-label="<?php esc_attr_e('Menü', 'black-to-white'); ?>">
    ...
    <div class="mobile-menu md:hidden">
        ...
        ?>
        <div class="mt-4">
            <a href="#contact" class="block w-full text-center bg-white text-black px-4 py-2 rounded-md">
                <?php _e('Kostenlos anfragen', 'black-to-white'); ?>
            </a>
        </div>
    </div>
